...
## el elemento es de hacer click y luego escribir.
    ...
    try:
        ...
        print('Hay que rellenar cosas en la segunda ventana :(')
    try:
        select = Select(driver.find_element_by_id('select-0'))
        select.select_by_value('DE')
    except:
        print('La segunda ventana no pide localizacion')
    try:
        element = driver.find_element(By.ID, 'form-action-continue')
        element.click()
        element = driver.find_element(By.ID, 'form-action-continue')
    ...
    try:
        ...
        element.click()
        element = driver.find_element(By.ID,'radio-option-2')
        element.click()
        element = driver.find_element(By.ID,'radio-option-3')
        element.click()
        element = driver.find_element(By.ID,'radio-option-4')
        element.click()

    except:
        print('Se han elegido las opciones')
    try:
        element = driver.find_element(By.ID, 'form-action-continue')
        element.click()
